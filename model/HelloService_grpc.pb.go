...
// HelloServiceClient is the client API for HelloService service.go.
//
...
// HelloServiceServer is the server API for HelloService service.go.
...
// UnsafeHelloServiceServer may be embedded to opt out of forward compatibility for this service.go.
...
// HelloService_ServiceDesc is the grpc.ServiceDesc for HelloService service.go.
